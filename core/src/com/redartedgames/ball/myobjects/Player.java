...
public class Player extends TimeObject{
	...
	public void updateBulletCollidable() {
		for(Bullet bullet : bullets) {
			bullet.collidableObjects = new ArrayList<GameObject>();
			bullet.collidableObjects.addAll(bulletObstacles);
		}
	}
	...
	public void shoot() {
		...
		bullets.get(bullets.size()-1).shoot(playerSprite.getMovement().getPosition().x, playerSprite.getMovement().getPosition().y, 150, -50);
